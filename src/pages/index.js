...
const IndexPage = () => (
  <Layout>
    ...
    <ul className={styles.list}>
      ...
      <li className={styles.listItem}>
        <Link className={styles.listItemLink} to="/campaigns">戰役與王牌出擊</Link>
    ...
    <ul className={styles.list}>
      <li className={styles.listItem}>
        <Link className={styles.listItemLink} to="/buildings">聯盟</Link>
        <p className={styles.listItemDescription}>加入和管理联盟，与其他玩家协作，增强整体实力。</p>
      </li>
      <li className={styles.listItem}>
        <Link className={styles.listItemLink} to="/resources">成員</Link>
        <p className={styles.listItemDescription}>分配和升級乘员，以提高舰队的战斗效率。</p>
      </li>
      <li className={styles.listItem}>
        <Link className={styles.listItemLink} to="/ships">商店</Link>
        <p className={styles.listItemDescription}>购买和兑换道具资源，强化游戏中的装备。</p>
      </li>
      <li className={styles.listItem}>
        <Link className={styles.listItemLink} to="/ships">加成</Link>
